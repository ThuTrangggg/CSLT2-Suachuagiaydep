    ...
    public partial class frmXuong : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblXuong SET  Tenxuong=N'" + txtTenxuong.Text.Trim().ToString() +
                    ...
                    "' WHERE Maxuong=N'" + txtMaxuong.Text + "'";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (txtTenxuong.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải nhập tên xưởng", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtTenxuong.Focus();
                return;
            }
            if (txtDiachi.Text.Trim().Length == 0)
            ...
            sql = "INSERT INTO tblXuong(Maxuong,Tenxuong, Diachi, Dienthoai) VALUES(N'" + txtMaxuong.Text.Trim() + "', N'" + txtTenxuong.Text.Trim() + "', N'" + txtDiachi.Text.Trim() + "', '" + mskDienthoai.Text + "')";
            Functions.runsql(sql);
            Load_DataGridView();
            ResetValues();
            btnXoa.Enabled = true;
