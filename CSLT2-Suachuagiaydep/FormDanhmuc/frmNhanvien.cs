    ...
    public partial class frmNhanvien : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (chkGioitinh.Checked == true)
                ...
                gt = "Nữ";
            sql = "SELECT Manhanvien FROM tblNhanvien WHERE Manv=N'" + txtManv.Text.Trim() + "'";
            ...
            sql = "INSERT INTO tblNhanvien(Manv,Tennv,Gioitinh, Diachi, Namsinh, Congviec, Luong) VALUES(N'" + txtManv.Text.Trim() + "', N'" + txtTennv.Text.Trim() + "', N'" + gt + "', N'" + txtDiachi.Text.Trim() + "', '" +txtCongviec.Text.Trim().ToString() + "', '" + txtLuong.Text.Trim().ToString() + "', '" + Functions.ConvertDateTime(mskNamsinh.Text) + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblNhanvien SET  Tennhanvien=N'" + txtTennv.Text.Trim().ToString() +
                    ...
                    "',Congviec= N'" +txtCongviec.Text.ToString() + "',Gioitinh=N'" + gt +
                    "',Namsinh='" + Functions.ConvertDateTime(mskNamsinh.Text) +
        ...
        private void mskNamsinh_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
                SendKeys.Send("{TAB}");
        }
